...
- [ ] Data Modeling & Storage – Schema blueprint drafted in `docs/data-modeling.md`; ingestion pipeline specification captured in `docs/ingestion-pipeline.md`; initial DDL assembled in `docs/sql/initial_schema.sql` awaiting Supabase validation, with migrations and RLS policies still outstanding.
