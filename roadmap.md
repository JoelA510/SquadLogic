...
**Status:** Baseline requirements and iteration plan captured in `docs/requirements.md`; awaiting confirmation with the league administrator and refinement based on real registration exports.
...
**Status:** Preferred architecture and platform decisions recorded in `docs/architecture.md`; need to validate cost assumptions, create proof-of-concept deployments, and document CI/CD setup.
