...
4. **Updates and dependencies** – Keep dependencies up to date (`react-scripts`, Supabase client, etc.) and monitor security advisories.  Since Vercel and Supabase update their platforms, regularly check for breaking changes or updated free‑tier policies.
