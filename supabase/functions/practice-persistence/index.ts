...
} from '../../../packages/core/src/teamPersistenceEdgeConfig.js'; // Reusing config for now
...
const PersistencePayloadSchema = z.object({
  snapshot: z.object({
    payload: z.object({
      assignmentRows: z.array(z.object({ team_id: z.string(), practice_slot_id: z.string() }).passthrough()),
    }),
  }),
